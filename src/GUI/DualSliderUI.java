...
import main.Calc.DualSlider;

/**
 * UI delegate for the RangeSlider component.  RangeSliderUI paints two thumbs,
 * one for the lower value and one for the upper value.
 */
public class DualSliderUI extends BasicSliderUI {
     ...
     * @param b RangeSlider
     */
    public DualSliderUI(DualSlider b) {
        super(b);
    }
    ...
    public void scrollByBlock(int direction) {
        synchronized (slider) {
            ...
            if (upperThumbSelected) {
                int oldValue = ((DualSlider) slider).getUpperValue();
                ((DualSlider) slider).setUpperValue(oldValue + delta);
            } else {
